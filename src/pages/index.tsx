...
export default function Home() {
  return (
    ...
    <Container>
      <div className="flex flex-col max-w-screen-xl px-2 w-full mt-14 mb-24 pb-24">
      {/* Desktop version */}
      <div className='hidden md:flex flex-row'>
        ...
        <div className='flex flex-col w-1/3 items-center justify-center'>
          <h1 className='textName text-xl sm:text-3xl md:text-5xl lg:text-8xl xl:text-10xl text-center'>
          ZIGZAG HACKS
          </h1>
        </div>
      </div>
    ...
    <div className='flex flex-col items-center justify-center mx-2 w-full'>
