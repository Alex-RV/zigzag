...
export default function Container(props) {
  ...
  return (
    ...
    <div className="flex fixed flex-col justify-center text-white bg-black w-full ">
      <nav className="flex top-0 left-0 right-0 fixed items-center justify-between w-full bg-black   px-8  pt-5 pb-2 sm:pb-3">
        {/* <div className='max-w-7xl'> */}
          ...
          <div className='flex flex-row gap-5 items-center '>
            ...
            <NextLink className='textNav text-3xl' href={''}>About</NextLink>
